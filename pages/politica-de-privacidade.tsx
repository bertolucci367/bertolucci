  ...
  return (
    <Layout title="Política de Privacidade">
      <div className="grid-in-main mb-20">
        ...
        <h2>Política de Cookies Bertolucci </h2>
        ...
        <p>
          ...
          e os recursos que eles adicionam a este site.
        </p>
        <p>
          É recomendável que você deixe todos os cookies se não tiver certeza se
